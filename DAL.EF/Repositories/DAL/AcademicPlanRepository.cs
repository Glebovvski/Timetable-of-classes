...
namespace Schedule_CodeFirstModel.Models
{
    public class AcademicPlanRepository : IRepository<AcademicPlan>
    {
        ...
        public void Update(AcademicPlan data)
        {
            ...
            readplan.Parameters["@SubjectId"].Value = data.SubjectId;
        ...
        public List<AcademicPlan> GetPlan(int id)
        {
            SqlCommand readplan = new SqlCommand("GetPlanForSpeciality", connection);
            readplan.CommandType = CommandType.StoredProcedure;
            readplan.Parameters.Add(new SqlParameter("@SpecialityId", SqlDbType.Int));
            readplan.Parameters["@SpecialityId"].Value = id;
            List<AcademicPlan> academicPlans = new List<AcademicPlan>();
            using (connection)
            {
                connection.Open();
